...
queried_walking_table = syn.tableQuery(("SELECT 'recordId', 'healthCode', 'deviceMotion_walking_rest.json.items', 'medTimepoint' FROM syn5511449 WHERE medTimepoint IN ('Immediately before Parkinson medication', 'Just after Parkinson medication (at your best)')").format("syn5511449"))
actv_walking = queried_walking_table.asDataFrame()
actv_walking['index'] = actv_walking.index


# In[4]:


json_files = syn.downloadTableColumns(queried_walking_table, "deviceMotion_walking_rest.json.items")
...
walk_json_files_temp = pd.DataFrame({"deviceMotion_walking_rest.json.items": [i[0] + '.0' for i in items], "rest_walk_json_file": [i[1] for i in items]})
...
actv_walking["deviceMotion_walking_rest.json.items"] = actv_walking["deviceMotion_walking_rest.json.items"].astype(str)
...
actv_walk_temp = pd.merge(actv_walking, walk_json_files_temp, on="deviceMotion_walking_rest.json.items")
actv_walk_temp
...
# into features later
for row in actv_walk_temp["rest_walk_json_file"]: 
...
actv_walk_temp['Rest_g_range_x'] = g_range_x
actv_walk_temp['Rest_g_range_y'] = g_range_y
actv_walk_temp['Rest_g_range_z'] = g_range_z
actv_walk_temp['Rest_g_mean_x'] = g_mean_x
actv_walk_temp['Rest_g_mean_y'] = g_mean_y
actv_walk_temp['Rest_g_mean_z'] = g_mean_z
actv_walk_temp['Rest_range_linear_acc_x'] = range_linear_acc_x
actv_walk_temp['Rest_range_linear_acc_y'] = range_linear_acc_y
actv_walk_temp['Rest_range_linear_acc_z'] = range_linear_acc_z
actv_walk_temp['Rest_mean_linear_acc_x'] = mean_linear_acc_x
actv_walk_temp['Rest_mean_linear_acc_y'] = mean_linear_acc_y
actv_walk_temp['Rest_mean_linear_acc_z'] = mean_linear_acc_z
actv_walk_temp['Rest_range_rot_acc_rx'] = range_rot_acc_rx
actv_walk_temp['Rest_range_rot_acc_ry'] = range_rot_acc_ry
actv_walk_temp['Rest_range_rot_acc_rz'] = range_rot_acc_rz
actv_walk_temp['Rest_mean_rot_acc_rx'] = mean_rot_acc_rx
actv_walk_temp['Rest_mean_rot_acc_ry'] = mean_rot_acc_ry
actv_walk_temp['Rest_mean_rot_acc_rz'] = mean_rot_acc_rz

actv_walk_temp['Rest_skew_rfft_linear_acc_x'] = skew_rfft_linear_acc_x
actv_walk_temp['Rest_skew_rfft_linear_acc_y'] = skew_rfft_linear_acc_y
actv_walk_temp['Rest_skew_rfft_linear_acc_z'] = skew_rfft_linear_acc_z
actv_walk_temp['Rest_skew_rfft_gravity_x'] = skew_rfft_gravity_x
actv_walk_temp['Rest_skew_rfft_gravity_y'] = skew_rfft_gravity_y
actv_walk_temp['Rest_skew_rfft_gravity_z'] = skew_rfft_gravity_z
actv_walk_temp['Rest_skew_rfft_rot_acc_rx'] = skew_rfft_rot_acc_rx
actv_walk_temp['Rest_skew_rfft_rot_acc_ry'] = skew_rfft_rot_acc_ry
actv_walk_temp['Rest_skew_rfft_rot_acc_rz'] = skew_rfft_rot_acc_rz
actv_walk_temp['Rest_skew_rfft_attitude_x'] = skew_rfft_attitude_x
actv_walk_temp['Rest_skew_rfft_attitude_y'] = skew_rfft_attitude_y
actv_walk_temp['Rest_skew_rfft_attitude_z'] = skew_rfft_attitude_z

actv_walk_temp['Rest_kurtosis_rfft_linear_acc_x'] = kurtosis_rfft_linear_acc_x
actv_walk_temp['Rest_kurtosis_rfft_linear_acc_y'] = kurtosis_rfft_linear_acc_y
actv_walk_temp['Rest_kurtosis_rfft_linear_acc_z'] = kurtosis_rfft_linear_acc_z
actv_walk_temp['Rest_kurtosis_rfft_gravity_x'] = kurtosis_rfft_gravity_x
actv_walk_temp['Rest_kurtosis_rfft_gravity_y'] = kurtosis_rfft_gravity_y
actv_walk_temp['Rest_kurtosis_rfft_gravity_z'] = kurtosis_rfft_gravity_z
actv_walk_temp['Rest_kurtosis_rfft_rot_acc_rx'] = kurtosis_rfft_rot_acc_rx
actv_walk_temp['Rest_kurtosis_rfft_rot_acc_ry'] = kurtosis_rfft_rot_acc_ry
actv_walk_temp['Rest_kurtosis_rfft_rot_acc_rz'] = kurtosis_rfft_rot_acc_rz
actv_walk_temp['Rest_kurtosis_rfft_attidude_x'] = kurtosis_rfft_attidude_x
actv_walk_temp['Rest_kurtosis_rfft_attidude_y'] = kurtosis_rfft_attidude_y
actv_walk_temp['Rest_kurtosis_rfft_attidude_z'] = kurtosis_rfft_attidude_z
actv_walk_temp['Rest_kurtosis_rfft_attidude_w'] = kurtosis_rfft_attidude_w

actv_walk_temp['Rest_sum_variances_g'] = sum_variances_g
actv_walk_temp['Rest_sum_std_g'] = sum_std_g
actv_walk_temp['Rest_sum_std_linear_acc'] = sum_std_linear_acc
actv_walk_temp['Rest_sum_variances_linear_acc'] = sum_variances_linear_acc
actv_walk_temp['Rest_sum_variances_rot_accel'] = sum_variances_rot_accel
actv_walk_temp['Rest_sum_std_rot_acc'] = sum_std_rot_acc
actv_walk_temp['Rest_sum_variances_attitude'] = sum_variances_attitude
actv_walk_temp['Rest_sum_std_attitude'] = sum_std_attitude

actv_walk_temp['Rest_x_zero_cross_rate'] = x_zero_cross_rate
actv_walk_temp['Rest_y_zero_cross_rate'] = y_zero_cross_rate
actv_walk_temp['Rest_z_zero_cross_rate'] = z_zero_cross_rate
...
actv_walk_temp.drop(["deviceMotion_walking_rest.json.items", "rest_walk_json_file"], axis=1, inplace=True)
...
reduced_data_set.to_csv('deviceMotion_rest_reduced.csv')
