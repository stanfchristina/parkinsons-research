...
main = pd.read_csv("deviceMotion_restAndOutbound.csv")
...
# Use l1 penalty to dampen effect of some features
...
ann = Sequential()
ann.add(Dense(4, activation='relu', kernel_initializer='random_normal', input_dim=108)) # First hidden layer
