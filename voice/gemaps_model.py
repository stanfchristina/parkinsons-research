...
features = loadmat('classificationGemapsFeaturesNormal.mat')
labels = loadmat('classificationGemapsLabels.mat')
...
ann = Sequential()
ann.add(Dense(4, activation='relu', kernel_initializer='random_normal', input_dim=62)) # First hidden layer
